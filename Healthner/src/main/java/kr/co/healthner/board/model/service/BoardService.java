...
public class BoardService {
	...
	public BoardPageDate boardSearchList(int reqPage, String boardType, String searchString) {
		int numPerPage = 10;
		...
		map2.put("boardType", boardType);
		map2.put("searchString",searchString);
		
		int totalCount = dao.totalSearchList(map2);
		...
		List list = dao.BoardSearchTitleList(map);
