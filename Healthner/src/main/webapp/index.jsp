...
<!-- 				<div -->
<!-- 					class="col-md-7 heading-section heading-section-white ftco-animate text-center"> -->
<!-- 					<span class="subheading"><small><i class="left-bar"></i>Gym -->
<!-- 							Classes<i class="right-bar"></i></small></span> -->
<!-- 					<h2 class="mb-1"> -->
<!-- 						What You Get From <span>Endurance</span> Membership -->
<!-- 					</h2> -->
<!-- 					<p> -->
<!-- 					<p>A small river named Duden flows by their place and supplies -->
...
<!-- 								<a href="#" -->
<!-- 									class="img d-flex justify-content-center align-items-center" -->
<!-- 									style="background-image: url(/resources/images/program-4.jpg);"> -->
<!-- 									<div class="text text-center d-flex align-items-end"> -->
<!-- 										<div class="desc"> -->
...
<!-- 								<a href="#" -->
<!-- 									class="img d-flex justify-content-center align-items-center" -->
<!-- 									style="background-image: url(/resources/images/program-5.jpg);"> -->
<!-- 									<div class="text text-center d-flex align-items-end"> -->
<!-- 										<div class="desc"> -->
<!-- 											<h3>Boxing</h3> -->
<!-- 											<p>A small river named Duden flows by their place and -->
...
<!-- 			var html = ""; -->
<!-- 			$.ajax({ -->
<!-- 				url: "/healthner/trainer/trainerCom.do", -->
<!-- 				method: "get", -->
<!-- 				success: function(data){ -->
<!-- 					html += '<div class="container">'+ -->
<!-- 								'<div class="row justify-content-center mb-5 pb-3">'+ -->
<!-- 									'<div class="col-md-7 heading-section text-center">'+ -->
<!-- 										'<span class="subheading"><small><i class="left-bar"></i>Testimonies<i'+ -->
<!-- 										'class="right-bar"></i></small></span>'+ -->
...
<!-- 											'<div class="text">'+ -->
<!-- 												'<p class="mb-4 pb-1 pl-4 line">'+data[i].trainingPostscript+'</p>'+ -->
<!-- 												'<div class="d-flex align-items-center">'+ -->
<!-- 													'<div class="user-img"'+ -->
<!-- 														'style="background-image: url(/resources/profile/'+data[i].memberProfile+')">'+ -->
<!-- 															'<span class="quote d-flex align-items-center justify-content-center">'+ -->
<!-- 																'<i class="icon-quote-left"></i>'+ -->
<!-- 															'</span>'+ -->
<!-- 													'</div>'+ -->
<!-- 													'<div class="ml-4">'+ -->
<!-- 														'<p class="name">'+data[i].memberNick+'</p>'+ -->
...
<!-- 					trainerComment.append(html); -->
<!-- 				} -->
<!-- 			}) -->
<!-- 		}) -->
<!-- 	</script> --> -->
<!-- 	<!-- Successful stories --> -->
<!-- 	<section class="ftco-section testimony-section" id="trainerComment"> -->
<!-- 		<div class="container"> -->
<!-- 			<div class="row justify-content-center mb-5 pb-3"> -->
<!-- 				<div class="col-md-7 heading-section ftco-animate text-center"> -->
<!-- 					<span class="subheading"><small><i class="left-bar"></i>Testimonies<i -->
...
<%-- 						<c:forEach items="${requestScope.trainerComment}" var="train"> --%>
						
<!-- 							<div class="item"> -->
<!-- 								<div class="testimony-wrap p-4 pb-5"> -->
<!-- 									<div class="text"> -->
<%-- 										<p class="mb-4 pb-1 pl-4 line">${train.trainingPostscript}</p> --%>
	
<!-- 										<div class="d-flex align-items-center"> -->
<!-- 											<div class="user-img" -->
<%-- 												style="background-image: url(/resources/images/${train.memberProfile})"> --%>
<!-- 												<span -->
...
<!-- 											</div> -->
<!-- 											<div class="ml-4"> -->
<%-- 												<p class="name">${train.memberNick }</p> --%>
<!-- 												<span class="position">Customer</span> -->
<!-- 											</div> -->
<!-- 										</div> -->
<!-- 									</div> -->
...
<!-- 				<div class="col-md-6 d-flex align-self-stretch img" -->
<!-- 					style="background-image: url(/resources/images/about-3.jpg);"> -->
<!-- 				</div> -->
...
<!-- 								<div class="text"> -->
<!-- 									<strong class="number" data-number="5000">0</strong> <span>Happy -->
<!-- 										Customers</span> -->
<!-- 								</div> -->
<!-- 							</div> -->
<!-- 						</div> -->
...
<!-- 							<div class="block-18 text-center"> -->
<!-- 								<div class="text"> -->
<!-- 									<strong class="number" data-number="4560">0</strong> <span>Perfect -->
<!-- 										Bodies</span> -->
<!-- 								</div> -->
<!-- 							</div> -->
<!-- 						</div> -->
...
<!-- 							<div class="block-18 text-center"> -->
<!-- 								<div class="text"> -->
<!-- 									<strong class="number" data-number="570">0</strong> <span>Working -->
<!-- 										Hours</span> -->
<!-- 								</div> -->
<!-- 							</div> -->
<!-- 						</div> -->
...
<!-- 							<div class="block-18 text-center"> -->
<!-- 								<div class="text"> -->
<!-- 									<strong class="number" data-number="900">0</strong> <span>Success -->
<!-- 										Stories</span> -->
<!-- 								</div> -->
<!-- 							</div> -->
<!-- 						</div> -->
