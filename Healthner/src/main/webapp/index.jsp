...
<body>
				...
				<div class="col-lg-12 d-block">
					<div class="row d-flex">
						<div class="col-md pr-4 d-flex topper align-items-center">
							...
							<span class="text">+82 1235 2355</span>
						</div>
						<div class="col-md pr-4 d-flex topper align-items-center">
							<div
								class="icon mr-2 d-flex justify-content-center align-items-center">
							...
							<span class="text">healthner@gmail.com</span>
						</div>
						<div
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item"><a href="/healthner/trainer/trainerFrm.do" class="nav-link">Trainers</a></li>
	...
	<section class="ftco-section ftco-about">
    	<div class="container">
    		<div class="row">
    			<div class="col-md-6">
    				<div class="img img-video d-flex align-items-center" style="background-image: url(/resources/images/about.jpg);">
    				...
    				<div class="thumb-wrap d-flex">
    					<a href="#" class="thumb img" style="background-image: url(/resources/images/program-1.jpg);"></a>
    					<a href="#" class="thumb img" style="background-image: url(/resources/images/program-2.jpg);"></a>
    					<a href="#" class="thumb img" style="background-image: url(/resources/images/program-3.jpg);"></a>
    				</div>
    			</div>
    			<div class="col-md-6 pl-md-5 ftco-animate d-flex align-items-center">
		          ...
		          <div class="heading-section mb-4">
		            ...
		            <h2 class="mb-1">Welcome to <span>Endurance</span> Crossfit Gym</h2>
		          </div>
		          ...
		          <p><a href="#" class="btn btn-primary p-3">Join us</a></p>
	          </div>
    			</div>
    		</div>
    	</div>
    ...
    <section class="ftco-section ftco-package-program bg-darken">
          ...
          <div class="col-md-7 heading-section heading-section-white ftco-animate text-center">
            ...
            <h2 class="mb-1">What You Get From <span>Endurance</span> Membership</h2>
            <p><p>A small river named Duden flows by their place and supplies it with the necessary regelialia.</p></p>
          </div>
        </div>
        	...
        	<div class="col-md-12">
              ...
              <div class="item">
              	<div class="package-membership ftco-animate">
		        			<a href="#" class="img d-flex justify-content-center align-items-center" style="background-image: url(/resources/images/program-1.jpg);">
              ...
              <div class="item">
              	<div class="package-membership ftco-animate">
		        			<a href="#" class="img d-flex justify-content-center align-items-center" style="background-image: url(/resources/images/program-2.jpg);">
		        				<div class="text text-center d-flex align-items-end">
		        					<div class="desc">
				        				<h3>Fat Burn</h3>
				        				<p>A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>
              ...
              <div class="item">
              	<div class="package-membership ftco-animate">
		        			<a href="#" class="img d-flex justify-content-center align-items-center" style="background-image: url(/resources/images/program-3.jpg);">
		        				<div class="text text-center d-flex align-items-end">
		        					<div class="desc">
				        				<h3>Cycling</h3>
				        				<p>A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>
              ...
              <div class="item">
              	<div class="package-membership ftco-animate">
		        			<a href="#" class="img d-flex justify-content-center align-items-center" style="background-image: url(/resources/images/program-4.jpg);">
		        				<div class="text text-center d-flex align-items-end">
		        					<div class="desc">
              ...
              <div class="item">
              	<div class="package-membership ftco-animate">
		        			<a href="#" class="img d-flex justify-content-center align-items-center" style="background-image: url(/resources/images/program-5.jpg);">
		        				<div class="text text-center d-flex align-items-end">
		        					<div class="desc">
				        				<h3>Boxing</h3>
				        				<p>A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>
    ...
    <section class="ftco-appointment">
    	...
    	<div class="container">
    		<div class="row d-md-flex align-items-center">
    			<div class="col-md-6 d-flex align-self-stretch img" style="background-image: url(/resources/images/about-3.jpg);">
    			</div>
	    		<div class="col-md-6 appointment pl-md-5 py-md-5 ftco-animate">
	    			...
	    			<form action="#" class="appointment-form">
	    				<div class="form-group">
	    					...
	    					<div class="d-flex">
		    					<input type="text" class="form-control mr-2" placeholder="키를 cm으로 입력해주세요">
	    				...
	    				<div class="form-group">
	    					<div class="d-flex">
	    						<div class="mr-2">
	    							<label for="height">몸 무개</label>
			    					<input type="text" class="form-control" placeholder="65kg">
			    				</div>
		    					<div class="ml-2">
					...
					<div class="ftco-footer-widget mb-4">
						...
						<div class="block-21 mb-4 d-flex">
							...
							<div class="text">
								...
								<div class="meta">
									<div>
										<a href="#"><span class="icon-calendar"></span> July 01,
											2019</a>
									</div>
									<div>
				...
				<div class="col-lg-2 col-md-6 mb-5 mb-md-5">
					<div class="ftco-footer-widget mb-4 ml-md-4">
						...
						<ul class="list-unstyled">
							...
							<li><a href="#" class="py-2 d-block">Improve Your
									Performance</a></li>
						</ul>
					</div>
				</div>
