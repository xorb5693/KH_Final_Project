...
<body>
			...
			<div class="row d-md-flex align-items-center justify-content-center">
				...
				<div class="col-md-12 appointment pl-md-5 py-md-5 ftco-animate">
					<div class="coach align-items-stretch">
						<span class="ftco-animate">최근 측정날짜 :
							${recentBmi.measureDate } / 이전 측정날짜 : ${prevBmi.measureDate }</span>
					</div>
	...
	var chartData = { labels: ["체수분", "단백질", "무기질", "체지방량", "체중", "골격근량", "BMI", "체지방률", "복부지방률"], 
			datasets: [
				...
				{ 
					data: [${prevBmi.bodywater}, ${prevBmi.protein}, ${prevBmi.mineral}, ${prevBmi.bodyfat},${prevBmi.weight}, ${prevBmi.bone}, ${prevBmi.bmi}, ${prevBmi.bodyfatPer}, ${prevBmi.abfatPer}], 
