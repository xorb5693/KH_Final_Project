			...
			<nav id="sidebar">
				<div class="p-4 pt-5">
					<c:if test="${empty sessionScope.member.memberProfile}">
						<div class="bordered"
							style="width: 300px; height: 300px; background-image: url(/resources/profile/noprofile.png); background-size: contain; background-repeat: no-repeat;">
						</div>
					</c:if>
					<c:if test="${not empty sessionScope.member.memberProfile}">
						<div class="bordered"
							style="width: 300px;height: 300px; background-image: url(/resources/profile/${sessionScope.member.memberProfile});background-size: contain;background-repeat: no-repeat;">
						</div>
					</c:if>
